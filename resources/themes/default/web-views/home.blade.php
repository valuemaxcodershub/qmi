...
@section('content')
    ...
    <div class="__inline-61">
                    ...
                    <div class="row __featured-deal-wrap" style="background: {{$web_config['primary_color']}};">
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="m-lg-4 mb-4">
                                <span
                                    class="featured_deal_title __pt-12">{{ translate('featured_deal')}}</span>
                                <br>

                                <span class="text-white text-left">{{ translate('see_the_latest_deals_and_exciting_new_offers')}}!</span>
        ...
        <div class="container rtl">
            <div class="row g-3 mb-4 pt-2 mt-0 pb-2 __deal-of">
                    ...
                    <div class="deal_of_the_day h-100" style="background: {{$web_config['primary_color']}}">
                        @if(isset($deal_of_the_day) && isset($deal_of_the_day->product))
                            <div class="d-flex justify-content-center align-items-center __w-70p mx-auto">
                                <h1 class="align-items-center text-white"> {{ translate('deal_of_the_day') }}</h1>
                            </div>
                        ...
                        @else
                            ...
                            @if(isset($product))
                                <div class="d-flex justify-content-center align-items-center">
                                    <h1 class="text-white"> {{ translate('recommended_product') }}</h1>
                                </div>
                                <div class="recomanded-product-card">
                                ...
                                <div class="card-body">
                                    <div class="row d-flex justify-content-between">
                                        <div class="seller-list-title">
                                            <span class="font-semibold">{{ translate('sellers')}}</span>
                                        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3 d-flex justify-content-center">
                        <div class="shipping-method-system">
                            ...
                            <div class="text-center">
                                <p class="m-0">
                                    {{ translate('fast_delivery_all_accross_the_country')}}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 d-flex justify-content-center">
                        <div class="shipping-method-system">
                            ...
                            <div class="text-center">
                                <p class="m-0">
                                    {{ translate('7_Days_Return_Policy')}}
                                </p>
                            </div>
                        </div>
                    </div>
