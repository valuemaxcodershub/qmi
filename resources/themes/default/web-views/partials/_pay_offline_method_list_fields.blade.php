@if ($method)
    ...
    <div class="py-4 text-end">
        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">{{translate('close')}}</button>
        <button type="submit" class="btn btn-sm btn--primary">{{translate('submit')}}</button>
    </div>

@else
    <div class="text-center py-5">
        <img class="pt-5" src="{{ asset('public/assets/front-end/img/offline-payments-vectors.png') }}" alt="">
