            ...
            <div class="details __h-100">
                ...
                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <span
                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'ml-2 mr-1' : 'ml-1 mr-2'}} pl-2 pr-2">{{$overallRating[1]}} {{translate('reviews')}}</span>
                        ...
                        <span style="width: 0px;height: 10px;border: 0.5px solid #707070; margin-top: 6px">    </span>
                        <span
                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'ml-2 mr-1' : 'ml-1 mr-2'}} pl-2 pr-2">  {{$countWishlist}}  {{translate('wishlist')}}</span>
                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    <div class="d-flex __gap-6 mt-0">
                        <div class="product-description-label mt-2 mr-2">{{translate('quantity')}}:</div>
