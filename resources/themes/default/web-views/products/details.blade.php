                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                            <div class="details __h-100">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                                    ...
                                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">{{$overallRating[1]}} {{translate('reviews')}}</span>
                                    <span class="__inline-25"></span>
                                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">{{$countOrder}} {{translate('orders')}}   </span>
                                    <span class="__inline-25">    </span>
                                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-0 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-0 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}} text-capitalize">  {{$countWishlist}} {{translate('wish_listed')}} </span>
                                    ...
                                    <div class="mt-2">
                                        <div class="product-quantity d-flex flex-wrap align-items-center __gap-15">
                                            <div class="d-flex align-items-center">
                                                <div class="product-description-label text-body mt-2">{{translate('quantity')}}:</div>
                                                <div
                        ...
                        <div class="shipping-details-bottom-border">
                            <div class="px-3 py-3">
                                <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"  src="{{asset("public/assets/front-end/png/Payment.png")}}"
                                        alt="">
                                <span>{{translate('safe_Payment')}}</span>
                            </div>
                        </div>
                        <div  class="shipping-details-bottom-border">
                            <div class="px-3 py-3">
                                <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"
                                    src="{{asset("public/assets/front-end/png/money.png")}}"
                                        alt="">
                                <span>{{ translate('7_Days_Return_Policy')}}</span>
                            </div>
                        </div>
                        <div class="shipping-details-bottom-border">
                        <div class="px-3 py-3">
                                <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"
                                    ...
                                    alt="">
                                <span>100% {{ translate('Authentic_Products')}}</span>
                        </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 msg-option mt-2" id="msg-option">
                                            ...
                                            <div class="d-flex mt-2 __gap-15">
                                                <button class="btn btn-secondary text-white d-block w-47" id="cancelBtn">{{translate('cancel')}}
                                                </button>
                                                <button class="btn btn-success text-white d-block w-47" id="sendBtn">{{translate('send')}}</button>
                                            </div>
    ...
    <script>
        ...
        $('#sendBtn').on('click', function (e) {
            ...
            if (msgValue != '') {
                ...
                toastr.error('{{ translate("say_something")}}!');
            }
        });
