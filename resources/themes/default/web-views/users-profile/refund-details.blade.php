...
@section('content')
    <div class="container text-center">
        <h2 class="headerTitle my-3">{{translate('refund_request')}}</h2>
    </div>
<!-- Page Content-->
