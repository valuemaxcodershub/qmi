...
<div class="__chat-seller">
    ...
    <div class="container rtl">
        <h3 class="text-center py-3 headerTitle m-0">{{ Request::is('chat/seller') ? translate('chat_with_seller') : translate('chat_with_delivery_man')}}</h3>
    </div>
                                        ...
                                        <div class="input_msg_write">
                                            <form
                                                ...
                                                <input class="form-control form-control-sm {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}} w-75"
                                                    id="msgInputValue" type="text" placeholder="{{translate('send_a_message')}}" aria-label="Search">
                                                <input class="aSend __w-45px" type="submit" id="msgSendBtn" value="{{translate('send')}}">
