            ...
            <section class="col-lg-8">
                ...
                <!-- Shipping methods table-->
                                ...
                                <ul class="list-group">
                                    @foreach($shipping_addresses as $key=>$address)
                                        <li class="list-group-item __inline-57" onclick="$('#sh-{{$address['id']}}').prop( 'checked', true )">
                                            ...
                                            <label class="badge"
                                                   style="background: {{$web_config['primary_color']}}; color:white !important;">{{translate($address['address_type'])}}</label>
                                            <small>
                                    ...
                                    <li class="list-group-item" onclick="anotherAddress()">
                                        ...
                                        <button type="button" class="btn btn-outline" data-toggle="collapse"
                                                data-target="#collapseThree">{{ translate('another_address')}}
                                        </button>
                                        <div id="accordion">
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputPassword1">{{ translate('address_type')}}</label>
                    ...
                    <div style="display: {{$billing_input_by_customer?'':'none'}}">
                        ...
                        <h2 class="h4 pb-3 mb-2 mt-4">{{ translate('choose_billing_address')}}</h2>
                                                    ...
                                                    @if(!auth('customer')->check())
                                                        <div class="form-group">
                                                            <label
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control"
                                                                   name="billing_contact_email" {{$billing_addresses->count()==0?'required':''}}>
                                                        </div>
                                                    @endif
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">{{ translate('phone')}}
