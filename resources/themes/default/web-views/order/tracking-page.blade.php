                ...
                <div class="card-body">
                    <form action="{{route('track-order.result')}}" type="submit" method="post" class="p-3">
                        ...
                        <div class="form-group mb-4">
                            <input class="form-control prepended-form-control" type="text" name="order_id" value="{{ old('order_id') }}"
                                placeholder="{{translate('order_id')}}" required>
                        </div>
                        <div class="form-group mb-4">
                            <input class="form-control prepended-form-control" type="text" name="phone_number" value="{{ old('phone_number') }}"
