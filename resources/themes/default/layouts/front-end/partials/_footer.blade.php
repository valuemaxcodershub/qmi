        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="{{ route('helpTopic') }}">
                    <div class="text-center">
                        <img class="size-60" src="{{ asset('public/assets/front-end/png/faq.png') }}" alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
                            {{ translate('FAQ') }}
            ...
            <div class="container text-center __pb-13px">
                ...
                <div
                    ...
                    <div class="col-md-3 footer-web-logo">
                        ...
                        <div class="store-contents d-flex pr-lg-4">
                        ...
                        <div class="row mt-4 {{ Session::get('direction') === 'rtl' ? ' flex-row-reverse' : '' }}">
                            <div class="col-md-7">
                                <div
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="mb-4 font-weight-bold footer-heder">{{ translate('start_a_conversation') }}</span>
                                    </div>
                                    <div
                            ...
                            <div class="col-md-5 ">
                                <div
                                    ...
                                    <div>
                                        <span
                                            class="mb-4 font-weight-bold footer-heder">{{ translate('address') }}</span>
                                    </div>
                                    <div
