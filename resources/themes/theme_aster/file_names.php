...
return [
    ...
    'cancellation_refund_return' => 'theme-views.pages.cancellation-refund-return',
    'premium_services' => 'theme-views.pages.premium-services',
    'trade_assurance' => 'theme-views.pages.trade-assurance',
    'boost_product' => 'theme-views.pages.boost-product',
    ...
    'login_view'=>'theme-views.customer-views.auth.login',
    'register_view'=>'theme-views.customer-views.auth.register',
    'verifyotp_view'=>'theme-views.customer-views.auth.loginotp',
    ...
    'fundwallet_view' => 'theme-views.payment.addmoney',
    'withdraw_view' => 'theme-views.withdrawal.index',
    'transact_pin_view' => 'theme-views.users-profile.transactpin',
    'user_bank_account' => 'theme-views.users-profile.bank-account',
];
