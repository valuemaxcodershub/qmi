                ...
                <div class="card-body">
                    ...
                    <div class="auto-col xxl-items-6 justify-content-center gap-3">
                        @foreach ($sellers as $shop)
                            ...
                            <a href="{{ route('seller-shop', $shop['seller']['business_shortcode']) }}" class="store-item grid-center py-2">
                                ...
                                <div class="d-flex flex-column align-items-center flex-wrap gap-2 mt-3">
                                    ...
                                    {!! $utilityService->getSellerType($shop->seller->sellertype->id, true) !!}
                    ...
                    @if (count($sellers) == 0)
                        <div class="w-100 text-center pt-5">
                            <img width="120" class="mb-3" src="{{ theme_asset('assets/img/not_found.png') }}"
                                alt="">
