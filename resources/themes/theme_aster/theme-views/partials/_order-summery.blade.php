    ...
    <div class="card text-dark sticky-top-80">
        <div class="card-body px-sm-4 d-flex flex-column gap-2">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <h2 class="text-primary">{{\App\CPU\Helpers::currency_converter($product_price_total+$total_shipping_cost-$coupon_dis-$total_discount_on_product-$order_wise_shipping_discount)}}</h2>
            </div>
