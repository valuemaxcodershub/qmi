                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        ...
                                        @if (count($order['details']) > 3)
                                            <h6 class="fw-medium fs-12 text-center">+{{ count($order['details']) - 3 }}
                                                <br>
                                                <a
                                                    href="{{ route('account-order-details', ['order_id' => $order['id']]) }}">{{ translate('more') }}</a>
                                            </h6>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="table-responsive hide-scrollbar">
                    <div class="d-flex gap-3 justify-content-between store-list">
                        ...
                        @foreach ($more_seller as $seller)
                            ...
                            <a href="{{ route('seller-shop', $seller['business_shortcode']) }}"
                                ...
                                <div class="d-flex flex-column align-items-center text-center gap-2 w-100">
                                    <h6 class="text-truncate text-center">{{ $seller->shop->name }}
                                        {!! $utilityService->getSellerType($seller->seller_type, true) !!}
                                    </h6>
