    ...
    <div class="container">
        <div class="card">
            <div class="p-3 p-sm-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4" style="background: #656664; padding: 15px;border-radius: 5px;">
                    ...
                    <div class="position-relative">
                        <div class="swiper" data-swiper-loop="true" data-swiper-margin="20"
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($top_sellers as $sellerIndex => $seller)
                                    @if ($seller->shop)
                                        <div class="swiper-slide align-items-start bg-light rounded">
                                            ...
                                            <div class="bg-light position-relative rounded p-3 p-sm-4 w-100">
                                                @if (count($seller->coupon) > 0)
                                                    <div class="offer-text">
                                                        {{ translate('USE_COUPON') }} : <span class="cursor-pointer"
                                                            onclick="coupon_copy('{{ $seller->coupon[0]['code'] }}')">{{ $seller->coupon[0]['code'] }}</span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="{{ count($seller->coupon) > 0 ? 'mt-4' : '' }} mb-3">
                                                    <h5 class="mb-1">
                                                        <a href="javascript:"
                                                            onclick="location.href='{{ route('seller-shop', $seller->business_shortcode) }}'">
                                                            {{ $seller->shop->name }} {!! $utilityService->getSellerType($seller->seller_type) !!}
                                                        </a>
                                                    </h5>
                                                        ...
                                                        @foreach ($seller->product as $product)
                                                            <a href="{{ route('product', $product['slug']) }}"
                                                                ...
                                                                <div class="store-product__top border rounded">
                                                                    ...
                                                                    <img width="100" style="height: 130px"
        ...
        {{-- @if (isset($footer_banner[1]))
            <div class="col-12 mt-3 d-sm-none">
                <a href="{{ $footer_banner[1]['url'] }}" class="ad-hover">
                    <img src="{{ asset('storage/app/public/banner') }}/{{ $footer_banner[1]['photo'] }}"
                        loading="lazy" alt=""
