                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                ...
                                                <ul class="option-select-btn flex-wrap style--two gap-4 mb-4">
                                                    <li>
                                                        <label>
                                                            <input type="radio" name="addressAs" hidden value="home"
                                                                checked>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control"
                                                    ...
                                                    placeholder="{{ translate('Ex:_Jhon_Doe') }}">
                                            </div>
                                            ...
                                            <div class="d-flex flex-wrap style--two gap-4 mb-3">
                                                <div class="d-none">
                                                    <label class="d-flex align-items-center gap-2 cursor-pointer">
                                                        <input type="radio" name="is_billing" value="1"
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex justify-content-end gap-3">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-primary">{{ translate('Update_Address') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
