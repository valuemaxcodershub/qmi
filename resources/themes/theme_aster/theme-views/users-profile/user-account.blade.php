                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="l_name" class="form-control"
                                                    value="{{ $customerDetail['l_name'] }}" name="l_name"
                                                    placeholder="{{ translate('Contact_Person_Name') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-inner-end-ele">
                                                    <input type="password" minlength="6" id="password"
                                                        ...
                                                        placeholder="{{ translate('Ex:_5+ character') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-inner-end-ele">
                                                    <input type="password" minlength="6" id="confirm_password"
                                                        ...
                                                        placeholder="{{ translate('Ex:_5+_character') }}">
                                                    <i class="bi bi-eye-slash-fill togglePassword"></i>
                                                </div>
                                            </div>
                                            <div id='message'></div>
                                                ...
                                                <div class="d-flex flex-column gap-3">
                                                    <div class="upload-file">
                                                        <input type="file" class="upload-file__input" name="image"
                                                            multiple aria-required="true" accept="image/*">
                                                        <div class="upload-file__img">
                                                            <div class="temp-img-box">
                                                                <div class="d-flex align-items-center flex-column gap-2">
                                                                    <i class="bi bi-upload fs-30"></i>
                                                                    <div class="fs-12 text-muted">
                                                                        {{ translate('change_your_profile') }}</div>
                                                                </div>
                                                            </div>
                                                            <img src="#" hidden=""
                                                                class="dark-support img-fit-contain border" alt="">
                                                        </div>
                                                    </div>

                                                    <div class="text-muted">{{ translate('Image_ratio_should_be') }} 1:1
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
