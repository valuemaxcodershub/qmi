                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="name" class="form-control" name="name"
                                                    placeholder="{{ translate('Ex:_Jhon_Doe') }}" required>
                                            </div>

                                            <div class="form-group mb-3">
                                                <label for="phone">{{ translate('Phone') }}</label>
                                                <input type="tel" id="phone" class="form-control " name="phone"
                                                    required placeholder="{{ translate('Ex:_01xxxxxxxxx') }}">
                                            </div>

                                            <div class="form-group mb-3 ">
                                                <label for="country">{{ translate('Country') }}</label>
                                                <select name="country" id="country" class="form-control select_picker"
                                                    required>
                                            ...
                                            <div class="form-group">
                                                <label for="zip-code">{{ translate('Zip_Code') }} <em
                                                        class="text-danger">(Optional)</em></label>
                                                <input class="form-control" type="text" id="zip" name="zip">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mt-5 mt-md-0">
                                            <br>
                                            <h6 class="fw-semibold text-muted mb-3">{{ translate('Choose_Address_Type') }}
                                            </h6>
                                            <div class="d-flex flex-wrap style--two gap-4 mb-3">
                                                <div class="d-none mb-4">
                                                    <label class="d-flex align-items-center gap-2 cursor-pointer">
                                                        <input type="radio" name="is_billing" checked=""
                                                            value="1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="address" rows="5" class="form-control"
                                                    placeholder="{{ translate('Ex:_1216_Dhaka') }}" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex justify-content-end gap-3">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-primary">{{ translate('Add_Address') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('script')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ \App\CPU\Helpers::get_business_settings('map_api_key') }}&callback=initAutocomplete&libraries=places&v=3.49"
        defer></script>
