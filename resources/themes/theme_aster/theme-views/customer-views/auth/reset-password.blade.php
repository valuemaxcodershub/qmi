                            ...
                            <form action="{{request('customer.auth.password-recovery')}}" class="reset-password-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-inner-end-ele">
                                        <input type="password" id="password2" name="password" min="8" class="form-control" placeholder="{{ translate('minimum_5_characters_long') }}" required="">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-inner-end-ele">
                                        <input type="password" id="confirm_password2" class="form-control" name="confirm_password" min="8" placeholder="{{ translate('minimum_5_characters_long') }}" required="">
                                        <i class="bi bi-eye-slash-fill togglePassword"></i>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center gap-3 mt-5">
                                    <button class="btn btn-primary px-sm-5" type="submit">Modify Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
