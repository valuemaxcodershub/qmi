...
@section('title', translate('Cancellation_Refund_Return_Policy').' | '.$web_config['name']->value.' '.translate('ecommerce'))
...
<main class="main-content d-flex flex-column gap-3 pb-3">
    ...
    >
        <div class="container">
            <h1 class="absolute-white text-center">Cancellation, Refund & Return Policy</h1>
        </div>
    </div>
    <div class="container">
        <div class="card my-4">
