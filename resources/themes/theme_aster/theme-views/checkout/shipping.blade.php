                    ...
                    <div class="card h-100">
                        <div class="card-body  px-sm-4">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <address>
                                                                                    <dl class="mb-0 flexible-grid sm-down-1" style="--width: 5rem">
                                                                                        ...
                                                                                        <span class="shipping-contact-state d-none">{{ $address['state'] }}</span>
                                                    ...
                                                    <div class="row mb-30">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select name="state" id="state" class="form-control select_picker select2" required>
                                                                    @forelse($states as $state)
                                                                        <option value="{{ $state['id'] }}">{{ $state['state_name'] }}</option>
                                                                    @empty
                                                                        <option value="">{{ translate('No_state_to_deliver') }}</option>
                                                                    @endforelse
                                                                </select>
                                                            </div>
                                                        </div>
                            ...
                            <div class="mt-5 {{ $billing_input_by_customer ? '':'d-none' }}">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between gap-3">
                                        ...
                                        @if($physical_product_view)
                                            <label class="custom-checkbox">
                                                ...
                                                <input type="checkbox" id="same_as_shipping_address" onclick="hide_billingAddress()" checked
                                ...
                                <form method="post" id="billing-address-form" class="d-none">
                                                                                ...
                                                                                <div class="card-body pb-0">
                                                                                    <address>
                                                                                        <dl class="mb-0 flexible-grid sm-down-1" style="--width: 5rem">
                                                                                            ...
                                                                                            <span class="billing-contact-state d-none">{{ $address['state'] }}</span>
    ...
    <script>
        ...
        */
        ...
        function shipping_method_select(cardBody){
            ...
            let shipping_state = cardBody.find('.shipping-contact-state').text();
        ...
        */
        ...
        function billing_method_select(cardBody){
            ...
            let billing_state = cardBody.find('.billing-contact-state').text();
