                    ...
                    <div class="card-body">
                                ...
                                @if ($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') != 'free_delivery'))
                                    <div class="free-delivery-area px-3 mb-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('public/assets/front-end/img/icons/free-shipping.png') }}"
                                                alt="" width="40">
                                    ...
                                    <div
                                        ...
                                        <div class="media gap-2">
                                            ...
                                            <div
                                                ...
                                                @foreach (json_decode($cartItem['variations'], true) as $key1 => $variation)
                                                    <div class="fs-12">{{ $key1 }} : {{ $variation }}
                                                    </div>
                                                @endforeach
                                                <div class="fs-12">{{ translate('Unit_Price') }} :
                                                    {{ \App\CPU\Helpers::currency_converter($cartItem['price'] * $cartItem['quantity']) }}
                        ...
                        <form method="get">
                            <div class="form-group mt-3">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="phoneLabel" class="form-label input-label"><strong>Delivery
                                                Note</strong> <span
                                                class="input-label-secondary"><em>Optional</em></span></label>
                ...
                $.post('{{ route('cart.updateQuantity') }}', {
                    ...
                    if (response.status == 0) {
                        ...
                        if (response['qty'] == ex_quantity.data('min')) {
                            ex_quantity.parent().find('.quantity__minus').html(
                                '<i class="bi bi-trash3-fill text-danger fs-10"></i>')
                        } else {
