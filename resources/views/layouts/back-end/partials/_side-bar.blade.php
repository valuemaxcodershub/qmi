    ...
    <aside style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <!-- Content -->
                <div class="navbar-vertical-content" style="background: red">
                    <!-- Search Form -->
                    <div class="sidebar--search-form pb-3 pt-4" style="visibility: hidden">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('seller_Products') }}">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            @if (count(config('get_theme_routes')) > 0)
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/banner*') || Request::is('admin/coupon*') || Request::is('admin/notification*') || Request::is('admin/deal*') ? 'scroll-here' : '' }}">
                                    <small class="nav-subtitle" title="">Banner
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/customer/wallet/bonus-setup') ? 'active' : '' }}">
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link " href="{{ route('admin.customer.withdraw_list') }}"
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/withdraw-method/list') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.sellers.seller-types') }}"
                                            title="Seller Types">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Seller Types</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/withdraw-method/list') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.sellers.seller-types-settings') }}"
                                            title="Seller Types">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Seller Types Settings</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/withdraw-method/list') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.sellers.seller-upgrade-request') }}"
                                            title="Seller Types">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Sellers Upgrade Request</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/state/index') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.state.index') }}"
                                            title="{{ translate('emergency_contact') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">State Management</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            ...
                            <li style="display: none"
                                ...
                                <a class="nav-link "
                                    href="{{ route('admin.business-settings.email-templates.index') }}"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/payment-method/*') || Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/page*') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/social-media') || Request::is('admin/file-manager*') || Request::is('admin/business-settings/features-section') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="d-none nav-item {{ Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/page*') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/features-section') ? 'active' : '' }}">
                                        <a class="nav-link"
                                    ...
                                    <li
                                        class="d-none navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/social-media') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/payment-method*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.payment-method.list-payout-banks') }}"
                                            title="Payout Banks">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.business-settings.commission') }}"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/competition*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('competition') }}">
                                    <i class="tio-user nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/competition*') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/competition/index') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.competition.index') }}"
                                            title="{{ translate('competition_list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('competition_list') }}</span>
                                        </a>
                                    </li>
                                    
                                    <li class="nav-item {{ Request::is('admin/competition/index') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.competition.credit-loyalty-wallet') }}"
                                            title="{{ translate('competition_loyalty_wallet') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('credit_loyalty_wallet') }}</span>
                                        </a>
                                    </li>
                            ...
                            <li style="display: nones"
                                class="d-none navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-config/environment-setup') || Request::is('admin/business-settings/web-config/mysitemap') || Request::is('admin/business-settings/analytics-index') || Request::is('admin/currency/view') || Request::is('admin/business-settings/web-config/db-index') || Request::is('admin/business-settings/language*') || Request::is('admin/business-settings/web-config/theme/setup') || Request::is('admin/system-settings/software-update') || Request::is('admin/business-settings/cookie-settings') || Request::is('admin/business-settings/otp-setup') || Request::is('admin/business-settings/web-config/app-settings') || Request::is('admin/addon') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
