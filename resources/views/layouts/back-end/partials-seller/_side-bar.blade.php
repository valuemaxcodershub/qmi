                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if ($seller_pos == 1)
                            @if ($seller->pos_status == 1)
                                <li class="nav-item">
                                    <small class="nav-subtitle">{{ translate('pos') }} {{ translate('system') }}
                                    </small>
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.shop.premiumservice') }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/competition*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('seller/competition*') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('seller/competition/list') ? 'active' : '' }}">
                                    <a class="nav-link "
                                        href="{{ route('seller.competition.list-competition') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Join Competition</span>
                                    </a>
                                </li>

                                <li
                                    class="nav-item {{ Request::is('seller/competition/list') ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ route('seller.competition.my-competition') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">My Competitions</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/business*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
