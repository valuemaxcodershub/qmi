<div id="headerMain" class="d-none">
    <header id="header" style="background: #656664"
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    ...
                    <li class="nav-item d-none d-md-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a
                                class="text-white js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle-left-arrow dropdown-toggle-empty" href="javascript:"
                    ...
                    <li class="nav-item d-none d-md-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a
                                class="text-white js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow" href="javascript:;"
                                data-hs-unfold-options='{
                    ...
                    <li class="nav-item d-none d-md-inline-block">
                        <!-- Notification -->
                        <div class="hs-unfold">
                            <a class="text-white js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                    ...
                    <li class="nav-item view-web-site-info">
                        <div class="hs-unfold">
                            <a class="text-white bg-white" onclick="openInfoWeb()" href="javascript:"
                    ...
                    <li class="nav-item">
                        <!-- Account -->
                        <div class="hs-unfold">
                            <a class="text-white js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow" href="javascript:;"
                               data-hs-unfold-options='{
