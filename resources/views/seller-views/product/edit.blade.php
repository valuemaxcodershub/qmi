        ...
        <form class="product-form text-start" action="{{ route('seller.product.update', $product->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                    ...
                                    @foreach (\App\CPU\Helpers::units() as $x)
                                        <option value={{ $x }} {{ $product->unit == $x ? 'selected' : '' }}>
                                            {{ $x }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color">{{ translate('purchase_price') }}(&#8358;)</label>
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('purchese_price') }}" name="purchase_price"
                                    class="form-control" value={{ \App\CPU\Convert::default($product->purchase_price) }}
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="{{ asset('public/assets/back-end/img/icons/product-upload-icon.svg') }}"
                                                                class="w-50">
                                                            <h3 class="text-muted">{{ translate('Image_Not_found') }}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="custom_upload_input position-relative border-dashed-2">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_101" class="h-auto aspect-1 bg-white"
            ...
            <div class="card mt-3 rest-part physical_product_show">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">Delivery State</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="delivery_state" class="pb-1 title-color">
                                    Delivery State
                                </label>
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                    name="delivery_state[]" id="delivery_state" multiple="multiple">
                                    @foreach (\App\Models\States::orderBy('state_name', 'asc')->get() as $stateIndex => $stateData)
                                        <option value="{{ $stateData['id'] }}"
                                            {{ in_array($stateData['id'], explode(',', $product['delivery_state'])) ? 'selected' : '' }}>
            ...
            <div class="d-flex justify-content-end mt-3">
                @if ($product->request_status == 2)
                    <button type="button" onclick="check()"
                        class="btn btn--primary px-5">{{ translate('resubmit') }}</button>
                @else
                    <button type="button" onclick="check()"
