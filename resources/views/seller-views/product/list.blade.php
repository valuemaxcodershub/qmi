                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="sub_category_id"
                                    ...
                                    <option
                                        ...
                                        {{ request('sub_category_id') != null ? $sub_category['defaultName'] : translate('select_Sub_Category') }}
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="sub_sub_category_id"
                                    ...
                                    <option
                                        ...
                                        {{ request('sub_sub_category_id') != null ? $sub_sub_category['defaultName'] : translate('select_Sub_Sub_Category') }}
                                    </option>
                                </select>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($p->request_status == 0)
                                                <label
                                                    class="badge badge-soft-warning">{{ translate('new_Request') }}</label>
                                            ...
                                            @if ($p['status'] == 1)
                                                <label class="switcher mx-auto">
                                                    <input type="checkbox" class="switcher_input"
                                                        id="product_status{{ $p['id'] }}" name="status" disabled
                                                        checked>
                                                    <span class="switcher_control" style="cursor: default"></span>
                                                </label>
                                            @else
                                                <label class="switcher mx-auto">
                                                    <input type="checkbox" class="switcher_input"
...
@push('script')
    ...
    <script>
        function getRequest(route, id, type) {
            $('#sub-sub-category-select').empty().append(
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        toastr.error(`{{ translate('status_updated_failed.') }} ${data.message}`);
                        setTimeout(function() {
                            location.reload();
                        }, 2000);
                    }
