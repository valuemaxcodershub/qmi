                        ...
                        <div class="card-body">
                            ...
                            <form id="form-id" action="{{ route('seller.auth.login') }}" method="post">
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control form-control-lg"
                                            ...
                                            aria-label="5+ characters required" required
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <div class="form-group d-flex jusify-content-center mt-2" style="width:fit-content;">
                                    ...
                                    <div class="d-flex jusify-content-center  m-0 p-0">
                                      <p class="text-muted" style="width:fit-content;">Dont have an account ? <a href="{{route('shop.apply')}}">Sign up</a></p>
