                            ...
                            <tbody>
                                @foreach ($withdraw_req as $k => $wr)
                                    <tr>
                                        ...
                                        <td>
                                            @if (isset($wr->user))
                                                <a href="{{ route('admin.customer.view', $wr->user_id) }}"
                                                    class="title-color hover-c1">{{ $wr->user->f_name . ' ' . $wr->user->l_name }}</a>
                                            @else
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                @if (isset($wr->user))
                                                    <a href="{{ route('admin.sellers.withdraw_view', [$wr['id'], $wr->user['id']]) }}"
