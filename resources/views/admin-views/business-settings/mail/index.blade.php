                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-10">
                                    <div class="d-flex align-items-end gap-2 gap-sm-3">
                                        ...
                                        <button type="button" onclick="send_mail()" class="btn btn--primary px-sm-5" data-toggle="modal" data-target="#sendMailConfirmationModal">
            ...
            if (ValidateEmail($('#test-email').val())) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#getInformationModal').modal('hide');
