...
@section('title', 'Sales Commission Settings')
        ...
        <div class="card">
            <div class="border-bottom px-4 py-3">
                <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                    <img width="20" src="{{asset('/public/assets/back-end/img/business-setup.png')}}" alt="">
                    {{translate('sales_commission_setup')}}
                </h5>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.business-settings.update-commission') }}">
                    @csrf
                    <div class="form-group">
                        <label for="">Commission Rate (%)</label>
                        <input type="text" class="form-control" name="sales_commission" value="{{ $sales_commission->value }}">
                    </div>
