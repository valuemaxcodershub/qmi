                ...
                <form enctype="multipart/form-data" id="theme_form">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-5 col-xl-5 col-xxl-5">
                            <!-- Drag & Drop Upload -->
                            <div class="uploadDnD">
                                <div class="form-group inputDnD position-relative theme_upload_input">
                                    ...
                                    <div class="position-absolute top-3 d-flex justify-content-center w-100 mt-2">
                                        <img src="{{ asset('public/assets/back-end/img/icons/bxs_cloud-upload.png') }}">
                                    </div>
                                </div>
                            </div>
