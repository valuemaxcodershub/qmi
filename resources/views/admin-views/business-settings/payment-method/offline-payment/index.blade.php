        ...
        <nav style="display: none">
            <div class="nav nav-tabs mb-3 border-0" role="tablist">
                ...
                <a class="nav-link {{ request('status') == 'active' ? 'active' : '' }}"
                    href="{{ route('admin.business-settings.payment-method.offline') }}?status=active">{{ translate('active') }}</a>
                <a class="nav-link {{ request('status') == 'inactive' ? 'active' : '' }}"
                    href="{{ route('admin.business-settings.payment-method.offline') }}?status=inactive">{{ translate('inactive') }}</a>
            </div>
        </nav>
                    ...
                    <div class="px-3 py-4">
                        <div class="row g-2 flex-grow-1">
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                <!-- Search -->
                                <form action="{{ route('admin.business-settings.payment-method.offline') }}"
                                    method="GET">
                            ...
                            <table
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th style="display: none">{{ translate('required_Info_From_Customer') }}</th>
                                        <th style="display: none" class="text-center">{{ translate('status') }}</th>
                                                ...
                                                <form
                                                    ...
                                                    <label class="switcher mx-auto">
                                                        <input type="checkbox" class="switcher_input"
                                                            id="method_status{{ $method['id'] }}" name="status"
