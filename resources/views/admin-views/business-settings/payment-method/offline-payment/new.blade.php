        ...
        <form action="{{ route('admin.business-settings.payment-method.offline.store') }}" method="POST"
            ...
            <div class="card mt-3">
                <div class="card-header gap-2 flex-wrap">
                    ...
                    <a href="javascript:" onclick="add_input_fields_group()" class="btn btn--primary" style="display: none"><i
                        ...
                        <div class="row align-items-end" id="{{ $aRandomNumber }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input_data[]" class="form-control" minlength="10" maxlength="10"
        ...
        function add_customer_input_fields_group() {
            ...
            if (counter < 100) {
                $('#customer-input-fields-section').append(
                    ...
                    `" name="is_required[${counter}]"> {{ translate('is_Required') }} ?
                                    </label>
                                </div>
