                    ...
                    <div class="media flex-column flex-sm-row gap-3">
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-block">
                                ...
                                @if (!empty($seller->business_shortcode) && $seller->status!="pending" && $seller->status!="suspended" && $seller->status!="rejected")
                                    <a href="{{ route('seller-shop', $seller->business_shortcode) }}" class="btn btn-outline--primary px-4" target="_blank">
                                        <i class="tio-globe"></i> {{translate('view_live')}}
                                    </a>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="row g-2">
                                    ...
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24">{{ $seller->wallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->wallet->total_earning)) : 0}}</h3>
                                                <div class="text-capitalize mb-0">{{translate('available_balance')}}</div>
                                            </div>
                                            <div>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24">{{ $seller->wallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->wallet->escrow_balance)) : 0}}</h3>
                                                <div class="text-capitalize mb-0">{{translate('escrow_balance')}}</div>
                                            </div>
                                            <div>
                                                <img width="40" class="mb-2" src="{{asset('/public/assets/back-end/img/pw.png')}}" alt="">
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24">{{ $seller->wallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->wallet->loyalty_balance)) : 0}}</h3>
                                                <div class="text-capitalize mb-0">{{translate('loyalty_balance')}}</div>
                                            </div>
                                            <div>
                                                <img width="40" class="mb-2" src="{{asset('/public/assets/back-end/img/pw.png')}}" alt="">
                                            </div>
