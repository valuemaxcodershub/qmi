...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode','guestCheck']], function () {
    ...
    Route::get('search-seller', 'WebController@search_seller')->name('search-seller');
    ...
    Route::get('cancellation-refund-return', 'PageController@cancellation_refund_return')->name('cancellation-refund-return');
    Route::get('premium-services', 'PageController@premiumService')->name('premium-services');
    Route::get('trade-assurance', 'PageController@tradeAssurance')->name('trade-assurance');
    Route::get('boost-product', 'PageController@boostProduct')->name('boost-product');
    ...
    //profile Route
    Route::get('bank-account', 'UserProfileController@bankAccountView')->name('user-bank-account')->middleware('customer');
    Route::put('modifybankaccount', 'UserProfileController@updateBankAccount')->name('user-update-bank-account')->middleware('customer');
    Route::get('security/pin', 'UserProfileController@transactPinView')->name('user-transact-pin')->middleware('customer');
    Route::put('update-securitypin', 'UserProfileController@updateTransactPin')->name('user-update-securitypin')->middleware('customer');
    ...
    Route::post('update-order', 'UserProfileController@updateOrder')->name('customer-update-order');
    ...
    Route::get('fundwallet', 'UserWalletController@fundWalletView')->name('fundwallet-view')->middleware('customer');
    Route::post('fundwallet', 'UserWalletController@handleWalletRequest')->name('fundwallet')->middleware('customer');
    Route::get('wallet','UserWalletController@index')->name('wallet')->middleware('customer');
    Route::get('withdraw-fund', 'WithdrawalController@index')->name('withdraw-fund')->middleware('customer');
    Route::post('initiate-withdrawal', 'WithdrawalController@initiateWithdrawal')->name('initiate-withdrawal')->middleware('customer');
    
    Route::get("/approve-payment/{processorType}", "UserWalletController@ApprovePayment")->name('user.approve-payment')->middleware('customer');
    ...
    //sellerShop
    Route::get('/{shopName}', 'ShopViewController@getSellerWithShopName')->name('seller-shop');
...
Route::group(['prefix' => 'shop', 'as' => 'shop.', 'namespace' => 'Seller\Auth'], function () {
    ...
    Route::get('verify/{token}', 'RegisterController@verifySeller')->name('verify-seller');
});
...
Route::get('/pavi-book-publishing', function() {
    return [];
})->name('pavi-book-publishing');