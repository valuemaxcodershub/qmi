...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'coupon', 'as' => 'coupon.','middleware'=>['module:promotion_management']], function () {
            Route::get('add-new', 'CouponController@add_new')->name('add-new')->middleware('admin');
            Route::post('store-coupon', 'CouponController@store')->name('store-coupon');
            Route::get('update/{id}', 'CouponController@edit')->name('update')->middleware('admin');
        ...
        Route::group(['prefix' => 'currency', 'as' => 'currency.','middleware'=>['module:system_settings']], function () {
            Route::get('view', 'CurrencyController@index')->name('view')->middleware('admin');
        ...
        Route::group(['prefix' => 'reviews', 'as' => 'reviews.','middleware'=>['module:user_section']], function () {
            Route::get('list', 'ReviewsController@list')->name('list')->middleware('admin');
            Route::get('export', 'ReviewsController@export')->name('export')->middleware('admin');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('withdraw_list', 'SellerController@customerWithdraw')->name('withdraw_list');
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('types', 'SellerController@sellerTypes')->name('seller-types');
            Route::get('types/create', 'SellerController@addSellerTypesView')->name('seller-types-create');
            Route::post('types/create', 'SellerController@addSellerTypes')->name('submit-seller-types-create');
            Route::get('types/delete/{id}', 'SellerController@deleteSellerTypes')->name('delete-seller-types');
            Route::get('types/edit/{id}', 'SellerController@sellerTypes_editView')->name('seller-types-edit');
            Route::put('types/update', 'SellerController@updateSellerType')->name('seller-types-update');
            Route::get('types/settings', 'SellerController@sellerTypeSettingsView')->name('seller-types-settings');
            Route::put('types/settings-update', 'SellerController@updateDefaultSellerType')->name('seller-types-settingsupdate');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'web-config', 'as' => 'web-config.','middleware'=>['module:system_settings']], function () {
                Route::get('/', 'BusinessSettingsController@companyInfo')->name('index')->middleware('admin');
            ...
            Route::group(['prefix' => 'seller-settings', 'as' => 'seller-settings.','middleware'=>['module:system_settings']], function () {
                Route::get('/', 'BusinessSettingsController@seller_settings')->name('index')->middleware('admin');
            ...
            Route::group(['prefix' => 'payment-method', 'as' => 'payment-method.','middleware'=>['module:system_settings']], function () {
                Route::get('/', 'PaymentMethodController@index')->name('index')->middleware('admin');
                ...
                Route::get('/offline-payment', 'OfflinePaymentMethodController@index')->name('offline')->middleware('admin');
                Route::get('/offline-payment/new', 'OfflinePaymentMethodController@create')->name('offline.new')->middleware('admin');
                Route::post('/offline-payment/store', 'OfflinePaymentMethodController@store')->name('offline.store')->middleware('admin');
                Route::get('/offline-payment/edit/{id}', 'OfflinePaymentMethodController@edit')->name('offline.edit')->middleware('admin');
                Route::post('/offline-payment/update', 'OfflinePaymentMethodController@update')->name('offline.update')->middleware('admin');
                Route::post('/offline-payment/delete', 'OfflinePaymentMethodController@delete')->name('offline.delete')->middleware('admin');
                Route::post('/offline-payment/status', 'OfflinePaymentMethodController@status')->name('offline.status')->middleware('admin');
            });

            Route::group(['middleware'=>['module:system_settings']],function(){
                Route::get('general-settings', 'BusinessSettingsController@index')->name('general-settings')->middleware('admin');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('view/{id}', 'OrderController@viewOrder')->name('view');
            Route::get('details/{id}', 'OrderController@details')->name('details');
            Route::post('status', 'OrderController@updateOrderStatus')->name('status');
            Route::post('delivery-date-update', 'OrderController@delivery_date_update')->name('delivery-date-update');
        ...
        Route::group(['prefix' => 'state', 'as' => 'state.'], function () {
            ...
            Route::get('index', 'StatesController@index')->name('index');
            Route::get('add', 'StatesController@createStateView')->name('add');
            Route::post('add', 'StatesController@createState')->name('add');
            Route::get('delete/{id}', 'StatesController@destroy')->name('delete');
        });
    });
});

Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware'=>['admin']], function () {
    Route::group(['namespace' => 'Seller', 'prefix' => 'sellers', 'as' => 'sellers.'], function () {
        Route::get('upgrade-request', 'BusinessController@SellersUpgradeRequest')->name('seller-upgrade-request');
        Route::get('view-upgrade/{reference}', 'BusinessController@viewUpgradeRequest')->name('view-upgrade-request');
        Route::get('update-upgrade/{reference}/{status}', 'BusinessController@submitUpgradeRequest')->name('update-request');
        Route::get('update-nin/{reference}/{status}', 'BusinessController@updateSellerNin')->name('update-nin');
        Route::post('decline-upgrade/{reference}/', 'BusinessController@declineUpgradeRequest')->name('decline-update-request');
        Route::get('kyc', 'BusinessController@kycVerify')->name('kyc');
        Route::post('verify-nin', 'BusinessController@verifyNIN')->name('verify-nin');
    });

    Route::group(['prefix' => 'competition', 'as' => 'competition.'],function() {
        Route::get('index', 'CompetitionController@index')->name('index');
        Route::get('add', 'CompetitionController@create')->name('add');
        Route::get('edit/{id}', 'CompetitionController@editview')->name('edit');
        Route::get('chart/{id}', 'CompetitionController@competitionChart')->name('chart');
        Route::post('create-competition', 'CompetitionController@add_competition')->name('addcompetition');
        Route::get('credit-loyalty-wallet', 'CompetitionController@creditLoyaltyView')->name('credit-loyalty-wallet');
        Route::put('credit-loyaltywallet', 'CompetitionController@creditLoyaltyWallet')->name('credit-loyaltywallet');
        Route::put('update', 'CompetitionController@update_competition')->name('updatecompetition');
        Route::get('delete/{id}', 'CompetitionController@delete')->name('delete');
    });
});

Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    Route::group(['prefix' => 'payment-method', 'as' => 'payment-method.'], function () {
        Route::get('/payout-banks', 'PayoutBanksController@payoutBanks')->name('list-payout-banks');
        Route::get('/fetchpayout-banks', 'PayoutBanksController@fetchBanks')->name('fetch-payout-banks');
    });

    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        Route::get('commission', 'Admin\BusinessSettingsController@commission')->name('commission');
        Route::post('update-commission', 'Admin\BusinessSettingsController@updateCommission')->name('update-commission');
    });
});
