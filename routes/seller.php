...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('submitotp', 'LoginController@submitOtpLogin')->name('submitotp');
    ...
    /*authenticated*/
    Route::group(['middleware' => ['seller', 'checkSellerShopName']], function () {
        //dashboard routes
        ...
        Route::group(['prefix' => 'shop', 'as' => 'shop.'], function () {
            ...
            Route::get('premiumservice', 'ShopController@premiumService')->name('premiumservice');
            Route::post('submit-boost-product', 'ShopController@boostProduct')->name('boost-product');
            Route::post('search-product', 'ShopController@searchProduct')->name('search-product');
            Route::get('approve-boosting-payment/{processorType}', 'ShopController@approveBoostingPaymentOnline')->name('approve-boosting-payment-online');
        });
        ...
        Route::group(['prefix' => 'business', 'as' => 'business.'], function () {
            Route::get('profile', 'BusinessController@index')->name('profile');
            Route::get('upgrade', 'BusinessController@upgradeBusinessView')->name('upgrade-business');

            Route::get('select-business-upgrade', 'BusinessController@selectMerchantPackage')->name('next-stage');
            Route::get('upload-attachment', 'BusinessController@POPUploadView')->name('pop-upload');
            Route::post('upload-attachment', 'BusinessController@submitPOP')->name('pop-upload');
            Route::post('submit-business-upgrade', 'BusinessController@processBusinessUpgrade')->name('submit-upgrade');
        });
        
        Route::group(['prefix' => 'competition', 'as' => 'competition.'], function () {
            Route::get('list', 'CompetitionController@competitionLists')->name('list-competition');
            Route::get('join/{id}', 'CompetitionController@joinCompetition')->name('join-competition');
            Route::get('view/{id}', 'CompetitionController@viewCompetition')->name('view-competition');
            Route::get('own', 'CompetitionController@myCompetitions')->name('my-competition');
            Route::get('chart/{id}', 'CompetitionController@competitionChart')->name('chart-competition');
        });
    ...
    Route::group(['middleware' => ['seller']], function () {
        Route::group(['prefix' => 'business', 'as' => 'business.'], function () {
            Route::get('business-shortcode', 'BusinessController@businessShortCode')->name('business-shortcode');
            Route::put('submit-shop-name', 'BusinessController@updateStoreName')->name('submit-shop-name');
        });
    });
