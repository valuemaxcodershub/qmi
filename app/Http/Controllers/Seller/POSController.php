...
class POSController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('seller-views.pos.index',compact('categories','cart_id','category','keyword','products','shop','customers'));
    }
    public function search_product(Request $request)
    {
        ...
        $products = Product::when($request->has('category_id') && $request['category_id'] != 0, function ($query) use ($request) {
                                ...
                                })->where(['added_by' => 'seller', 'user_id' => \auth('seller')->id()])->where('status', 1)->paginate(6);
            ...
            foreach ($cart as $key => $cartItem) {
                if (is_array($cartItem) && $cartItem['id'] == $request['id'] && $cartItem['variant'] == $str) {
                    ...
                    return response()->json([
                        ...
                        'view' => view('seller-views.pos._cart-summary')->render(),
                    ]);
                }
            }
    ...
    public function customer_edit(Request $request)
    {
        ...
        return response()->json([
            'flag' => 'inactive',
            'view' => view('seller-views.pos._customer-edit-modal', compact('user'))->render(),
        ]);
    }
    ...
    public function view_all_hold_orders(Request $request)
    {
        ...
        return response()->json([
            'flag' => 'inactive',
            'total_hold_orders' => $total_hold_orders,
            'view' => view('seller-views.pos._view-hold-orders', ['customer' => $request->customer])->render(),
        ]);
    }
    ...
    public function cancel_customer_order(Request $request)
    {
        ...
        return response()->json([
            'status' => 'success',
            'view' => view('seller-views.pos._view-hold-orders')->render(),
        ]);
    }
