...
class MostDemandedController extends Controller
{
    ...
    public function store (Request $request){
        ...
        DB::table('most_demandeds')->insertGetId([
            ...
            'banner' => $request->has('image') ? ImageManager::upload('most-demanded/', 'png', $request->file('image')) : 'def.png',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
    ...
    public function update(Request $request,$id){
        $most_demanded_product = $this->most_demanded->find($id);
        if ($request->image) {
            $most_demanded_product['banner'] = ImageManager::update('most-demanded/', $most_demanded_product['banner'], 'png', $request->file('image'));
