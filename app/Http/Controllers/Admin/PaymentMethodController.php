...
class PaymentMethodController extends Controller
{
    ...
    public function index()
    {
        ...
        $payment_gateways = Setting::whereIn('settings_type', ['payment_config'])->whereIn('key_name', ['paystack', 'flutterwave'])->get();
    ...
    public function payment_config_set(Request $request)
    {
        ...
        // return array_merge($validator->validate(), ['callback_url' => route($request['gateway'].".callback")]);
        ...
        Setting::updateOrCreate(['key_name' => $request['gateway'], 'settings_type' => 'payment_config'], [
            ...
            'live_values' => array_merge($validator->validate(), ['callback_url' => route($request['gateway'].".callback")]),
            'test_values' => array_merge($validator->validate(), ['callback_url' => route($request['gateway'].".callback")]),
