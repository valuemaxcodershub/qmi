...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $data['commission_escrow'] = $admin_wallet!=null?$admin_wallet->commission_escrow:0;
        $data['delivery_charge_earned'] = $admin_wallet!=null?$admin_wallet->delivery_charge_earned:0;
        $data['delivery_charge_escrow'] = $admin_wallet!=null?$admin_wallet->delivery_charge_escrow:0;
        $data['pending_amount'] = $admin_wallet!=null?$admin_wallet->pending_amount:0; //Admin sales...
        $data['withdrawn'] = $admin_wallet!=null?$admin_wallet->withdrawn:0;

        // $data['inhouse_earning'] = $admin_wallet!=null?$admin_wallet->inhouse_earning:0;
        $data['total_earning'] = (float) $data['commission_earned'] + $data['commission_escrow'] + $data['delivery_charge_earned'] + $data['delivery_charge_escrow'] + $data['pending_amount'];
